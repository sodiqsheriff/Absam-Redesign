...
const Footer =() =>{
    return(
        <div className='fixed-bottom mb-0 pb-0 h-full  w-full'>
         <div className="flex flex-col w-full px-5 pt-48 md:flex-row md:px-8 md:gap-0 md:space-x-20  md:pt-16 lg:flex-row lg:px-20 lg:pt-36 lg:gap-36 ">
